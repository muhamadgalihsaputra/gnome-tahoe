...
var HanabiExtensionPreferences = class extends ExtensionPreferences {
...
function prefsRowInt(window, prefsGroup, title, key, subtitle, lower, upper, stepIncrement, pageIncrement) {
  const settings = window.settings;
  const row = new Adw.ActionRow({ title, subtitle });
  prefsGroup.add(row);
...
export {
  HanabiExtensionPreferences as default
};
